...
| tempFB | Temperature of the bottom faces | User-defined |
| tempFR | Temperature of the right faces | User-defined |
| tempFT | Temperature of the top faces | User-defined |
| tempFL | Temperature of the left faces | User-defined |
